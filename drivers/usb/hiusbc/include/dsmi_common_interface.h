...
typedef enum {
    ...
    DSMI_LP_SUB_CMD_SET_STRESS_TEST,
    DSMI_LP_SUB_CMD_GET_AIC_CPM,
    DSMI_LP_SUB_CMD_GET_BUS_CPM,
    DSMI_LP_SUB_CMD_MAX,
} DSMI_LP_SUB_CMD;
...
#define DSMI_QOS_SUB_CMD_MAKE_V2(qos_main_index, qos_sub_index, qos_sub_cmd) (((qos_main_index) << \
    DSMI_QOS_MAIN_INDEX_OFFSET) | (qos_sub_index) << DSMI_QOS_SUB_INDEX_OFFSET | (qos_sub_cmd))
...
struct dms_fault_event {
    ...
    unsigned char os_id;
    unsigned char resv[DMS_MAX_EVENT_RESV_LENGTH - 1]; /**< os_id occupy 1byte, reserve 31byte */
};
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend910,Ascend610,as31xm1,Ascend310P,Ascend910B,bs9sx1a
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend610,as31xm1,bs9sx1a
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310P,Ascend910,Ascend910B
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend310P,Ascend910,Ascend910B
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend310P,Ascend910,Ascend910B,Ascend610,as31xm1,bs9sx1a
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend910,Ascend310P,Ascend910B
*/
...
* @param [out] schedule  Device power consumption: unit is W, accuracy is 0.1W. 16-bit unsigned short type,
               little endian
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend910,Ascend910B
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend910,Ascend310P,Ascend910B
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend910,Ascend910B
*/
...
* @param [in] device_id  The device id
* @return  0 for success, others for fail
* @note Support:Ascend310, Ascend310P
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend910,Ascend610,as31xm1,Ascend310P,Ascend310,Ascend310B,Ascend910B,bs9sx1a
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend910,Ascend610,as31xm1,Ascend310P,Ascend310B,Ascend910B,bs9sx1a
*/
 ...
 * @return  0 for success, others for fail
 * @note Support:Ascend910,Ascend610,Ascend310P,Ascend310B,Ascend910B,bs9sx1a,as31xm1
 */
 ...
 * @param [in] type determine the system to different sleep type
 * @return  0 for success, others for fail
 * @note Support:Ascend310B,as31xm1
 */
 ...
 * @return  0 for success, others for fail
 * @note Support:Ascend610,bs9sx1a,as31xm1
 */
 ...
 * @return  0 for success, others for fail
 * @note Support:Ascend610,Ascend910B,bs9sx1a,as31xm1
 */
 ...
 * @return  0 for success, others for fail
 * @note Support:Ascend610,as31xm1,Ascend310P,Ascend310B,Ascend910,Ascend910B,bs9sx1a
 */
...
* @return  0 for success, others for fail
* @note Support:Ascend610,bs9sx1a,Ascend310P
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend910,Ascend310P,Ascend910B
*/
...
* @return  0 for success, others for fail
* @note Support:Ascend310,Ascend310B,Ascend910,Ascend310P,Ascend910B,Ascend610,as31xm1,BS9SX1A
*/
