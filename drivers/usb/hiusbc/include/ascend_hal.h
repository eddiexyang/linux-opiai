 ...
 */
#define __HAL_API_VER_PATCH 0x13
...
struct halSensorNodeCfg {
    ...
    unsigned char Reserve[41]; /* 41: reserve bytes */
};
...
* @param [in] devId   Device ID
* @param [in] Handle  user sensor handle
* @param [in] val     user update value
* @return   0 for success, others for fail
*/
...
* @attention Available online, not offline. This interface is used with drvMemConvertAddr.
* @param [in] struct DMA_ADDR *ptr[] : Address array to be released
* @param [in] uint32_t num : num of ptr
* @return DRV_ERROR_NONE : success
* @return DV_ERROR_XXX : destroy fail
*/
...
* @attention Available online, not offline. This interface is used with drvMemConvertAddr.
* @param [in] struct DMA_ADDR *ptr : Information to be DMA copy
* @param [in] int Flag: Sumbit DMA copy use synchronize or asynchronous mode, use enum MEMCPY_SUMBIT_TYPE
* @return DRV_ERROR_NONE : success
...
* @param [in] struct DMA_ADDR *ptr : Information to be wait dma finish
* @return DRV_ERROR_NONE : success
...
* @attention null
* @param [out]  enum halHdcTransType *transType
* @return   DRV_ERROR_NONE, DRV_ERROR_INVALID_VALUE
*/
...
* @attention null
* @param [in]  enum halHdcTransType transType  [HDC_TRANS_USE_SOCKET=0, HDC_TRANS_USE_PCIE=1]
* @return   DRV_ERROR_NONE, DRV_ERROR_INVALID_VALUE
*/
...
* @attention null
* @param [in]  HDC_SESSION session
* @param [in]  int time_out
* @param [out] struct drvHdcFastRecvMsg *msg
* @return   DRV_ERROR_NONE, DRV_ERROR_INVALID_VALUE
*/
...
* @param [in]  HDC_SESSION session   : Specify in which session to receive data
* @param [in]  int bufLen            : The length of each receive buffer in bytes
* @param [in]  struct drvHdcRecvConfig userConfig : Record the parameters set by the user
* @param [out] struct drvHdcMsg *msg : Descriptor pointer for receiving messages
* @param [out] int *recvBufCount      : The number of buffers that actually received the data
* @return   DRV_ERROR_NONE, DRV_ERROR_INVALID_VALUE
*/
...
* @param [in] event_num: num of events
...
/**
* @ingroup driver
* @brief  event handle api
* @attention just for aicpu process
* @param [in] devId: logic devid
 ...
 * @param [in] iv  fixed part of crypto initialization vector
